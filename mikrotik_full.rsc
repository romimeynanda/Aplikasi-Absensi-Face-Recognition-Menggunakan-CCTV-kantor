# 2026-01-19 14:57:26 by RouterOS 7.21rc6
# software id = NMRW-F621
#
# model = RB450Gx4
# serial number = E1D80EB1B554
/interface bridge
...
/queue type
add kind=pcq name=pcq-download-lan pcq-classifier=dst-address
add kind=pcq name=pcq-upload-lan pcq-classifier=src-address
/queue simple
add comment="PCQ System - Nama tetap CAKE agar Netwatch Aman" max-limit=550M/550M name=01_Total_Office_CAKE queue=pcq-upload-lan/pcq-download-lan target=10.10.10.0/24
/routing table
...
add action=mark-connection chain=prerouting comment=3_PCC_ISP1_300Mbps_slot0 connection-mark=no-mark connection-state=new in-interface=bridge-lan new-connection-mark=ISP1_conn per-connection-classifier=both-addresses-and-ports:11/0
add action=mark-connection chain=prerouting comment=3_PCC_ISP1_300Mbps_slot1 connection-mark=no-mark connection-state=new in-interface=bridge-lan new-connection-mark=ISP1_conn per-connection-classifier=both-addresses-and-ports:11/1
add action=mark-connection chain=prerouting comment=3_PCC_ISP1_300Mbps_slot2 connection-mark=no-mark connection-state=new in-interface=bridge-lan new-connection-mark=ISP1_conn per-connection-classifier=both-addresses-and-ports:11/2
add action=mark-connection chain=prerouting comment=3_PCC_ISP1_300Mbps_slot3 connection-mark=no-mark connection-state=new in-interface=bridge-lan new-connection-mark=ISP1_conn per-connection-classifier=both-addresses-and-ports:11/3
add action=mark-connection chain=prerouting comment=3_PCC_ISP1_300Mbps_slot4 connection-mark=no-mark connection-state=new in-interface=bridge-lan new-connection-mark=ISP1_conn per-connection-classifier=both-addresses-and-ports:11/4
add action=mark-connection chain=prerouting comment=3_PCC_ISP1_300Mbps_slot5 connection-mark=no-mark connection-state=new in-interface=bridge-lan new-connection-mark=ISP1_conn per-connection-classifier=both-addresses-and-ports:11/5
add action=mark-connection chain=prerouting comment=3_PCC_ISP2_250Mbps_slot6 connection-mark=no-mark connection-state=new in-interface=bridge-lan new-connection-mark=ISP2_conn per-connection-classifier=both-addresses-and-ports:11/6
add action=mark-connection chain=prerouting comment=3_PCC_ISP2_250Mbps_slot7 connection-mark=no-mark connection-state=new in-interface=bridge-lan new-connection-mark=ISP2_conn per-connection-classifier=both-addresses-and-ports:11/7
add action=mark-connection chain=prerouting comment=3_PCC_ISP2_250Mbps_slot8 connection-mark=no-mark connection-state=new in-interface=bridge-lan new-connection-mark=ISP2_conn per-connection-classifier=both-addresses-and-ports:11/8
add action=mark-connection chain=prerouting comment=3_PCC_ISP2_250Mbps_slot9 connection-mark=no-mark connection-state=new in-interface=bridge-lan new-connection-mark=ISP2_conn per-connection-classifier=both-addresses-and-ports:11/9
add action=mark-connection chain=prerouting comment=3_PCC_ISP2_250Mbps_slot10 connection-mark=no-mark connection-state=new in-interface=bridge-lan new-connection-mark=ISP2_conn per-connection-classifier=both-addresses-and-ports:11/10
